...
var TableStore = function (_Component) {
  ...
  TableStore.prototype.updateData = function updateData(props) {
    ...
    if (defaultSort) {
      ...
      var _columns2 = this.state.columns;

      var sortColumn = _columns2.find(function (column) {
  ...
  TableStore.prototype.setCurrentRow = function setCurrentRow() {
    var _this3 = this;
  ...
  TableStore.prototype.changeSortCondition = function changeSortCondition(column, order) {
    ...
    if (!column) {
      ...
      column = _state2.sortColumn;
      order = _state2.sortOrder;
